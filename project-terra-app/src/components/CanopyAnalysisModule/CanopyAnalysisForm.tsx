...
interface CanopyAnalysisFormProps {
  plot: VegetationPlot;
  onAnalysisComplete: (analysisResults: AnalysisResults) => void;
}

const CanopyAnalysisForm = ({ onAnalysisComplete }: CanopyAnalysisFormProps) => {
  ...
  return (
    <div className="space-y-6">
      <div className="card">
        <h3 className="text-xl font-bold mb-4 border-b border-gray-200 dark:border-gray-700 pb-2">Canopy Analysis</h3>
...
export default CanopyAnalysisForm;